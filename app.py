...
html, body, [class*="css"], .stApp, .stMarkdown, .stTextInput, .stSelectbox, .stDateInput, .stTimeInput, .stRadio, button, input, p, h1, h2, h3, h4, label {
    font-family: 'Inter', -apple-system, BlinkMacSystemFont, sans-serif !important;
    letter-spacing: -0.01em;
}

/* Material Icons / Symbols must keep their special font so they render as icons, not text */
[class*="material-symbols"], [class*="MaterialIcons"], [class*="material-icons"],
span[data-testid*="icon"], span[data-testid*="Icon"],
[data-testid="stExpanderToggleIcon"], [data-testid="stExpanderIcon"],
